                        ...
                        <div className='h-screen'>
                                ...
                                <div className="relative w-full flex justify-center">
                                    <button className="w-3/4 bg-gradient-to-b from-blue-100 via-blue-200 to-blue-300 drop-shadow-lg rounded-b-2xl h-72 overflow-hidden flex justify-center items-center hover:opacity-85">
                                        <img src="capa.jpg" className="object-cover w-full h-full" />
                                    </button>
                                    <button className="absolute top-60 right-40 w-10 h-10 rounded-full z-10 border-4 overflow-hidden border-white overflow-hidden bg-white">
                                    ...
                                    <div className="flex justify-center">
                                        <button className="absolute left-48 top-60 w-32 h-32 rounded-full z-10 border-4 border-white overflow-hidden bg-white">
                                            <img src="perfil.jpg" className="object-cover w-full h-full hover:opacity-85" />
                                        </button>
                                        ...
                                        <div className='absolute right-44 top-72 w-32 h-12 rounded-2xl bg-white'>
                                            <button className="w-32 h-12 rounded-2xl z-10 bg-gradient-to-b from-blue-500 via-blue-600 to-blue-700 text-white hover:opacity-85">
                                                Conversar
                                                <ChatIcon />
                                            </button>
                                        </div>
